				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="客户密码" prop="kehumima">
							<el-input class="list_inp" v-model="form.kehumima" placeholder="客户密码"
								type="password" :readonly="!isAdd||disabledForm.kehumima?true:false" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='kehumima'){
					form.value.kehumima = row[x];
					disabledForm.value.kehumima = true;
					continue;
				}
				if(x=='kehuxingming'){
